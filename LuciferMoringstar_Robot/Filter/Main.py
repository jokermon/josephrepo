...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [[
                InlineKeyboardButton('Update Channel', url='https://t.me/cinehut_updates'),
                InlineKeyboardButton('Source Code', url="https://t.me/onnpoderka/2")
                ],[
                InlineKeyboardButton('💫JOIN BACKUP💫', url='https://t.me/joinchat/s3MC2Q0hHVw0Y2U9')
                ]]
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('💫 JOIN BACKUP CHANNEL 💫', url='https://t.me/joinchat/s3MC2Q0hHVw0Y2U9')
                    ]
                    ]
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🖥️ JOIN NOW 🖥️', url='https://t.me/joinchat/s3MC2Q0hHVw0Y2U9')
                    ]
                    ]
